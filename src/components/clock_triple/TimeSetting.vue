<template>
    <div class="flex gap-10">
        ...
        <TimeSelect :options="[0, 3, 5, 10, 15, 20, 30, 60]" unit="分鐘" v-if="1" v-model:result="time_setting.initial_time"
        ...
        <TimeSelect :options="[0, 10, 15, 20, 30, 40, 50, 60]" unit="秒" v-if="1" v-model:result="time_setting.byoyomi"
            v-model:enable="byoyomi_select"></TimeSelect>
    </div>
...
const initial_time_select = ref(false);
const byoyomi_select = ref(false);
